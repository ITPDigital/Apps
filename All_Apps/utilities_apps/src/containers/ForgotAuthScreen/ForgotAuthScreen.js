...
class ForgotAuthScreen extends PureComponent<Props> {
  ...
  componentDidMount = () => {
    Analytics.setCurrentScreen('FORGOT_PASSWORD');
  };
  ...
  onSuccess = (message: string) => {
    ...
    navigation.navigate('MessageAuthScreen', {message, success: true});
  };
...
export default connect(mapStateToProps, mapDispatchToProps)(ForgotAuthScreen);
