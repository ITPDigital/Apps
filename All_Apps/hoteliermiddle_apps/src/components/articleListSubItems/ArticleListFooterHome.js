...
export default function ArticleListFooterHome(props: Props) {
  const {
    time,
    isCenter,
    isBookMarked,
  ...
  return ( 
    <Animated.View style={[styles.container,  tabContainerStyle || null,{opacity: fadeAnim,     transform: [{
			translateY: fadeAnim.interpolate({ 
			  inputRange: [0, 1], 
			  outputRange: [100, 0.5]  // 0 : 150, 0.5 : 75, 1 : 0
			}),
		  }],}]}>
      ...
      >
        <Image
          source={require('../../asset/Images/black_share.png')}
          style={{
            height: 18,
            width: 14,
          }}
...
ArticleListFooterHome.defaultProps = {
  time: '',
  isCenter: false,
  isBookMarked: false,
