...
import { TextInput, Button, AuthBackground, TextButton, BuildFeedButton } from "../../components";
			...
			<View style={styleUI.textContainer}>
				<View style={styleUI.flexDirection}>
					<Text style={styleUI.text}>
						{`${Strings.authentication.I_AGREE_WITH_ARABIANBUSINESS} `}
						<Text
							style={styleUI.privacy}
							onPress={() => Linking.openURL("https://www.itp.com/privacy-policy")}
						>
						...
						<Text style={styleUI.textTerms} numberOfLines={2}>
							...
							<Text
								style={styleUI.privacy}
								onPress={() => Linking.openURL("https://www.itp.com/terms")}
							>
