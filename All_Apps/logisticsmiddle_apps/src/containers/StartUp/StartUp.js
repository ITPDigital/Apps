...
import {View, StyleSheet, Image, Dimensions, AsyncStorage, Linking, Animated, Easing} from 'react-native';
  ...
  render() { 
    ...
    return (
      <Animated.View style={styles.container}>              
        <Animated.Image 
          resizeMode="contain"  
          source={require('../../asset/Images/ablogo.png')}  
          style={[styles.image, {
            // Bind opacity to animated value 
            opacity: this.state.fadeAnim,
            marginBottom:this.state.fadeAnim.interpolate({
              inputRange: [0, 1],
              outputRange: [-1000, 0]  
            }),
            transform: [ 
